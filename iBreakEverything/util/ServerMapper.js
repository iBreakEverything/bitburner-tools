 ...
 * Set alias to check server data: alias servers="nano /iBreakEverything/data/servers.js"
...
export async function main(ns) {
    ...
    // For users
    await ns.write('/iBreakEverything/data/servers.js', preamble + JSON.stringify(_scanData, null, 2) + ';\n', 'w');
    // For scripts
    await ns.write('/iBreakEverything/data/servers.txt', JSON.stringify(_scanData, null, 2), 'w');
}
