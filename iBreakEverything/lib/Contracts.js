 ...
 * @param {Array<Number> | Array<Number, Array<Number>>} data 
 * @returns {Number}
 */
 ...
 * @param {Array<Array<Number>>} data Array of arrays of 2 numbers
 ...
 * @param {Array<Array<Number>>} data Triangle
 * @returns {Number}
 */
 ...
 * @param {Array<Number>} data Array with grid dimensions
 * @returns {Number}
 */
 ...
 * Determine how many unique paths there are from start to finish.
 * @param {Array<Array<Number>>} data Matrix with numbers
 * @returns {Number}
 */
